...
@implementation YMShareItemCell
...
- (void)layoutSubviews
{
    ...
    // 图标
    CGFloat iconViewX = YM_ItemCellPadding / 2;
    CGFloat iconViewY = topPadding;
    CGFloat iconViewW = cellWidth - YM_ItemCellPadding;
    CGFloat iconViewH = cellWidth - YM_ItemCellPadding;
...
- (void)iconClick
{
    if (self.item.selectionHandler) {
        [[NSNotificationCenter defaultCenter] postNotificationName:YM_HideNotification object:nil];
